		...
		<div className="">
			...
			<ul className="mt-2">
               ...
               <TechItem
                  ...
                  phone={tech.phone}
                  roles={tech.roles}
                  isTechAdded={isTechAdded}
                  removeTechHandle={removeTech}
							...
							>
								<Dialog.Panel className="panel border-0 py-1 px-4 rounded-lg overflow-hidden w-full max-w-lg my-8 text-black dark:text-white-dark">
                                    ...
                                    />
										...
										<div className="mt-10">
											<button type="button" className="btn btn-primary w-full" onClick={saveNewTechs}>
												{saveNewTechStatus ? 'Saving...' : 'Save'}
											</button>
										</div>
									</div>
								</Dialog.Panel>
