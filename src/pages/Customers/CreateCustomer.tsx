...
const CreateCustomer = () => {
   ...
   const handleParseAddress = () => {
      ...
      if(result.addressLine2) 
         dataForm.address2 = result.addressLine2;
      if(result.placeName)
         dataForm.city = result.placeName;
      if(result.stateAbbreviation)
         dataForm.state = result.stateAbbreviation;
      if(result.zipCode)
            ...
            <div className="panel">
               ...
               <form className="space-y-6">
                  ...
                  <div className={`${phoneError && 'has-error'}`}>
                     ...
                     <input type="text" placeholder="Phone" name="phone" className="form-input w-full" value={dataForm.phone} onChange={handleChangeFomr}/>
